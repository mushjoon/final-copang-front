...
const MainPage = () => {
    return(
        <div style={{width:'100%',height:'100%'}}>
            <strong style={{fontSize:'20pt'}}>오늘의 발견</strong>&nbsp;&nbsp;<span style={{fontSize:'15pt',color:'#777'}}> | COPANG이 엄선한 가장 HOT한 상품!</span>
            <ul className="MainImage" style={{float:'left'}}>
                ...
                <li><img style={{width:'628px',height:'500px'}} alt="" src="https://static.alconn.co/image/11904a7c-b750-4fce-89e1-8ecf78e2cf58"/></li>
