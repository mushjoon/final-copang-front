    ...
    const axiosAddQuestion = async () => {
      const questionData = {
        ...
        itemDetailId:
          ...
          ProductOne.itemDetailFormList[0].itemDetailId,
    ...
    <div className="product-question-desc">
      <div>
        ...
        <div className="product-question-desc-header">
          ...
          >
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 상품문의
            <span className="product-question-span">
              <button
                type="button"
                className="product-question-button"
                onClick={openModal}
              >
                문의하기
              </button>
            ...
            >
              <tbody className="question-tbody">
                <tr style={{ border: "1px solid #777777" }}>
                  <th style={{ width: "10%", border: "1px solid #777777" }}>
                    상품정보
                  </th>
          ...
          <div className="product-question-body-wrap">
            <div className="product-question-body">
              {Question.length !== 0 ? (
                Question &&
                Question.map((row, idx) => {
                  return (
                    <div>
                      <div
                        className="product-question-body2"
                        row={row}
                        key={idx}
                      >
                        <strong>
                        ...
                        <span className="product-question-writeday">
                          {row.registerDate}
                        </span>
                        <br />
