        ...
        <div className="MyCopangAddr-box">
            <Card className={classes.root} variant="outlined">
                    ...
                    <Box >
                        <CardContent className={classes.cardContent} key={addr.addressId}>
                            ...
                            <Typography variant="h6" component="h2">
                                <MarkunreadMailboxRoundedIcon color={'primary'} /> {addr.address} {addr.detail}
                            </Typography>
                            <Typography className={classes.pos} color="textSecondary">
                            ...
                            <CardActions>
                                <Button className={classes.deleteBtn} onClick={() => onDelete(addr.addressId)}>삭제</Button>
                                <Button className={classes.updateBtn} onClick={() => history.push({ pathname: "/mycopang/address-update-page", state: { addrValues: addr } })}>수정</Button>
                            </CardActions>
                        </CardContent>
                ...
                <div className="MyCopangAddr-add-wrap" style={{ display: 'flex', justifyContent: 'center' }}>
                    <Button variant="contained" color="primary" className={classes.addBtn} onClick={() => history.push('/mycopang/address-add-page')}>
                        추가하기
                </Button>
                </div>
            </Card>
