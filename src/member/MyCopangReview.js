                    ...
                    reviewList.data && reviewList.data.map((review, idx) => (
                        <Card className={classes.root}>
                            <CardActionArea>
                                ...
                                <CardContent style={{padding:'5px'}}>
                                    ...
                                    <Typography variant="body2" color="textSecondary" component="p">
                                        {review.itemName} {review.optionName ? review.optionName : "옵션이름 메롱"}, {review.optionValue ? review.optionValue : "옶션값 널값"} 등록일 : {review.registerDate}
                                    </Typography>
                                    <Typography variant="body2" color="textSecondary" component="p">
                                        구매후기 : {review.content}
                                    </Typography>
                            ...
                            <CardActions>
                                ...
                                <Button size="small" className={classes.updateBtn} onClick={() => history.push("/mycopang/review-page/update", review)}>
                                    수정
                                </Button>
                            </CardActions>
                            <br/>
