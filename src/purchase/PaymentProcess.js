...
function Payment() {   
    ...
    function callback(res) {
        ...
        if (success) {
            ...
            //res.imp_uid 받아와서
            axios.post("https://alconn.co/api/orders/"+orderId+"/pay/"+imp_uid) // 우리쪽 api로 imp_uid를 보내줌
            .then(res => { setCompleteRes(res) })
    ...
    return (
        <>
            <button type='button' onClick={onClickPayment}>pay</button><br/>
